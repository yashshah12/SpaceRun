...
public class LevelSection extends GameObject {
	...
	private static final float STARTING_X = SpaceRun.WIDTH + 20;
	...
	private void generateObjects(String sType, int nObjects, ArrayList<GameObject> alObjects, boolean onPlatform) {
		for (int i = 0; i < nObjects; i++) {
			...
			if (sType == "Obstacle") {
				gameObject = new Obstacle(MathUtils.random(Obstacle.TYPE_SINGLE_BOX, Obstacle.TYPE_THREE_BOX), new Vector2(), level);
