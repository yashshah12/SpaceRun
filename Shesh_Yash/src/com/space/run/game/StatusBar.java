	...
	public void render(SpriteBatch batch) {
        ...
        //if (Gdx.app.getType().equals(Application.ApplicationType.Android)) {
            if (fStateTime >= 0 && fStateTime <= 2.5) {
                Assets.fontBlack.draw(batch, "Tap Left ", 30, SideScroller.HEIGHT / 2 - 80);
                Assets.fontBlack.draw(batch, "To Jump ", 30, SideScroller.HEIGHT / 2 - 100);
                Assets.fontBlack.draw(batch, "Tap Right ", SideScroller.WIDTH / 2 + 150, SideScroller.HEIGHT / 2 - 80);
                Assets.fontBlack.draw(batch, "To Shoot ", SideScroller.WIDTH / 2 + 150, SideScroller.HEIGHT / 2 - 100);
            }
        //}
	}
